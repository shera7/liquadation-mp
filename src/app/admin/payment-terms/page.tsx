  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="text-sm text-steel mb-6">
        Эти условия клиент сможет выбрать в форме заявки на товар. Диапазон «от / до» задаёт,
        для каких по цене товаров (в USD, по текущему курсу) доступно условие — например,
        «Рассрочка» от 5 000 до 20 000 USD. Пустое «до» = без верхнего предела,
        пустые оба поля = условие доступно для любой суммы.
      </p>
