...
export default async function GeneralRequestsPage({ searchParams }: PageProps) {
  ...
  return (
    <div>
      ...
      <RequestsTable requests={pageItems as any} admins={admins} basePath="/admin/requests/general" />
      <PaginationControls page={page} pageSize={pageSize} total={total} basePath="/admin/requests/general" />
    </div>
  );
}
