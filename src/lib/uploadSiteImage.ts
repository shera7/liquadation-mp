/**
 * Загружает изображение настроек сайта (логотип, favicon и т.п.)
 * в папку site/ — отдельно от фото товаров и маркетинговых баннеров.
 */
export async function uploadSiteImage(file: File): Promise<string> {
  ...
  const fileName = `site/${crypto.randomUUID()}.${fileExt}`;
